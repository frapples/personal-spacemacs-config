 ...
 (defun user-function/org-return ()
   ...
   (cond ((user-function/org-at-p '(link footnote-definition footnote-reference timestamp)) (org-open-at-point))
         ((org-at-heading-p) (end-of-line) (if (org-entry-is-todo-p)
                                               (org-insert-todo-heading-respect-content)
                                             (org-insert-heading-respect-content)))
         ((org-at-item-checkbox-p) (evil-next-line) (beginning-of-line) (org-insert-item t))
         ((org-at-item-p) (evil-next-line) (beginning-of-line) (org-insert-item))
