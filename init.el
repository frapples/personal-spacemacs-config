...
values."
  (setq-default
   ...
   '(
     ...
     ;; 个人配置层
     frapples-private-core ; 个人写的辅助函数
     frapples-private-evil-extends
     frapples-private-org
     frapples-private-org-agenda
     frapples-private-ui
     )
   ...
   ;; 自己需要安装的额外的插件。
   dotspacemacs-additional-packages '(kotlin-mode flycheck-kotlin
...
`dotspacemacs/user-config' first."
  ...
  ;; 因此正确的方式是放在.profile或.bash_profile里面。
  ;; 这个选项默认会检查这一点并且给出提示，设为nil关闭检查


  (setq exec-path-from-shell-check-startup-files nil)
  (setq frame-title-format "super-vim  %f") ; 设置窗口标题



  ;; spacemacs.org/doc/FAQ.html#orgheadline14
  (setq tramp-ssh-controlmaster-options
        "-o ControlMaster=auto -o ControlPath='tramp.%%C' -o ControlPersist=no")


  (dolist (filename (remove "init.el" (directory-files "~/.spacemacs.d/" nil ".*\\.el$")))
    (load-file (expand-file-name filename "~/.spacemacs.d/")))
